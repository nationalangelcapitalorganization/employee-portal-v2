...
const UserArticleSummary = ({article, departments}) => {
  ...
  return (
    <div className="card z-depth-0 article-summary">
      ...
      <div className="card-content grey-text text-darken-3">
        ...
        <Link to={`/article/${article.id}`} key={article.id}><Button className='grey lighten-1 white-text z-depth-0 button-spacing' waves='light'>View</Button></Link>
        <Link to={`/article/${article.id}/edit`} key={article.id}><Button className='grey lighten-1 white-text z-depth-0 button-spacing' waves='light'>Edit</Button></Link>
        <Modal
                trigger={
                ...
                actions={<div><Button onClick={handleDelete} className="modal-close red lighten-1 btn z-depth-0 yes-button">
                I am sure
              </Button>
